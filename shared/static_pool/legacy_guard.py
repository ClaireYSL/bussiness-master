...
LEGACY_WORKBOOK_WRITE_CONFIRMATION = "I_UNDERSTAND_LEGACY_WRITE"


def legacy_write_enabled(cli_override: bool) -> bool:
    return bool(cli_override) and os.getenv(LEGACY_WORKBOOK_WRITE_ENV, "").strip() == LEGACY_WORKBOOK_WRITE_CONFIRMATION
...
def assert_legacy_workbook_write_allowed(*, cli_override: bool, context: str) -> None:
    ...
    raise PermissionError(
        ...
        f"{LEGACY_WORKBOOK_WRITE_ENV}={LEGACY_WORKBOOK_WRITE_CONFIRMATION} to proceed."
    )
