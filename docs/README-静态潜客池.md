...
- [内部运营-静态潜客池-共享版.xlsx](/Users/clairaipartner/Documents/Obsidian-Codex/潜客池/内部运营-静态潜客池-共享版.xlsx)
- [治理与证据.xlsx](/Users/clairaipartner/Documents/Obsidian-Codex/潜客池/治理与证据.xlsx)
- [潜客档案库.xlsx](/Users/clairaipartner/Documents/Obsidian-Codex/潜客池/潜客档案库.xlsx)
- [知识资产注册表.xlsx](/Users/clairaipartner/Documents/Obsidian-Codex/潜客池/知识资产注册表.xlsx)

说明：

- `共享版.xlsx`：当前最稳定的团队消费入口
- `治理与证据.xlsx`：别名、老客排除、evidence、queue 等治理层
- `潜客档案库.xlsx`：阅读层和公司级档案层
- `知识资产注册表.xlsx`：原素材、学习队列、正式知识资产
...
不要再默认从旧 `workspace` 或旧 `dingtalk_docs` 路径找素材。
