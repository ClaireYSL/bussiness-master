...
- 模式：`write_back`
- 状态：`success`
- 开始：`2026-04-27T00:06:36.729134+00:00`
- 结束：`2026-04-27T00:06:39.959097+00:00`

## 阶段结果

- enrich：`status=success`，`result_count=12`，`output=deliveries/archive/milestones/milestone6r_trust/milestone6r_trust_enrich_v1.json`
- promote：`status=success`，`result_count=12`，`output=deliveries/archive/milestones/milestone6r_trust/milestone6r_trust_promote_v1.json`

## 执行摘要

- promote 判定：`allow=0 / warn=12 / block=0`
